...
- **Colours:** body grey `#6b7280`, main muscles `#3ddc97` (the app's accent), helping muscles `#1f9e6a`. No outlines: the thin dark lines are just gaps between shapes showing the background.
