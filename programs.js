...
const PROGRAMS = [
  { id: "start", title: "Start Here: Full Body", goals: ["strong"], level: "beginner", gear: "Bodyweight and a sturdy table", mins: 30,
    ...
    link: "v1/t:Start-Here-Full-Body"
      ...
      + "/sat:Walk:walk.30m" },
  { id: "lose", title: "Lose Weight at Home", goals: ["lose"], level: "beginner", gear: "Resistance bands", mins: 35,
  ...
  { id: "gym-first", title: "Gym First Steps", goals: ["strong"], level: "beginner", gear: "Gym machines", mins: 40,
  ...
  { id: "muscle-db", title: "Build Muscle: Dumbbells", goals: ["strong"], level: "intermediate", gear: "Dumbbells and a bench", mins: 50,
  ...
  { id: "muscle-gym", title: "Build Muscle: Gym", goals: ["strong"], level: "intermediate", gear: "Gym", mins: 55,
  ...
  { id: "barbell", title: "Barbell Strength Basics", goals: ["strong"], level: "intermediate", gear: "Barbell and rack", mins: 50,
  ...
  { id: "posture", title: "Desk Worker: Posture and Back", goals: ["move"], level: "beginner", gear: "Resistance bands", mins: 25,
  ...
  { id: "joint", goals: ["strong", "move"], level: "intermediate", gear: "Dumbbells and a bench", mins: 50,
  ...
  { id: "mobility", title: "Mobility and Recovery", goals: ["move"], level: "beginner", gear: "Bodyweight", mins: 20,
