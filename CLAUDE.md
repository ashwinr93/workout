...
- **Quick facts** (level · equipment · joints it's easy on / loads) show in a preview's button row and under "Up next" on the rest screen; not on the coaching screen, which is full in landscape (owner asked; the rest screen is where you grab the kit).
